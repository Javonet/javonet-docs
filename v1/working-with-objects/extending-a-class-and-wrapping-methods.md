...
:keywords: Javonet, Extending Class, Wrapping Methods, `{called_technology}`, `{calling_name}`, Windows, Linux, MacOS, NObject, JObject, Class Extension, Method Wrapping, Constructor Invocation
:::
