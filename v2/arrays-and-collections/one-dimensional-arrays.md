:::options
:title: Use 1D arrays from `{called_name}` in `{calling_name}`.
:description: This article provides general description of working with one-dimensional arrays from `{called_name}` in `{calling_name}`.
...
# Working with 1D arrays from `{called_name}` in `{calling_name}`.
...
## Get element of an 1D array from `{called_name}` in `{calling_name}`.
...
## Set element of an 1D array from `{called_name}` in `{calling_name}`.
...
## Get size of an array from `{called_name}` in `{calling_name}`.  
