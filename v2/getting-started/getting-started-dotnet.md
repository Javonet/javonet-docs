...
:keywords: Javonet, `{called_name}` Getting Started, `{calling_name}`, .NET Developers, .NET Integration, Library Usage, Method Calls, Interacting Technologies, Runtime Installation, Activation Key, Sample Application, Runtime Context, Static Field Access
:::
