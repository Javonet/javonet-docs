...
my $library_path = "${javonet_src_root}/testResources/netcore/NetcoreTestClass.dll";
...
sub Test_Netcore_StandardLibrary_InvokeStaticMethod_Math_Abs_Minus50_50 {
    ...
    my $call = Javonet->in_memory()->netcore()->get_type("System.Math")->invoke_static_method("Abs", -50)->Execute();
...
sub Test_Netcore_StandardLibrary_GetStaticField_MathPI_PI {
    ...
    my $call = Javonet->in_memory()->netcore()->get_type("System.Math")->get_static_field("PI")->Execute();
    my $result = $call->get_value();
    # </StandardLibrary_GetStaticField>
    return $result;
}
...
sub Test_Netcore_StandardLibrary_InvokeInstanceMethod_SystemDateTime_ToShortDateString_Contains2022 {
    ...
    my $instance = Javonet->in_memory()->netcore()->get_type("System.DateTime")->create_instance(2022, 9, 1)->Execute();
...
sub Test_Netcore_TestResources_InvokeStaticMethod_MultiplyByTwo_25_50 {
    ...
    Javonet->in_memory()->netcore()->load_library($library_path);
    my $call = Javonet->in_memory()->netcore()->get_type($class_name)->invoke_static_method("MultiplyByTwo", 25)->Execute();
    my $result = $call->get_value();
    # </TestResources_InvokeStaticMethod>
    return $result;
}
...
sub Test_Netcore_TestResources_GetStaticField_StaticValue_3 {
    ...
    Javonet->in_memory()->netcore()->load_library($library_path);
    my $call = Javonet->in_memory()->netcore()->get_type($class_name)->get_static_field("StaticValue")->Execute();
    my $result = $call->get_value();
    # </TestResources_GetStaticField>
    return $result;
}
...
sub Test_Netcore_TestResources_InvokeInstanceMethod_MultiplyTwoNumbers_4_5_20 {
    ...
    Javonet->in_memory()->netcore()->load_library($library_path);
    my $instance = Javonet->in_memory()->netcore()->get_type($class_name)->create_instance()->Execute();
...
sub Test_Netcore_TestResources_GetInstanceField_PublicValue_1 {
    # <TestResources_GetInstanceField>
    Javonet->in_memory()->netcore()->load_library($library_path);
    my $instance = Javonet->in_memory()->netcore()->get_type($class_name)->create_instance(1, 2)->Execute();
...
my $test_result_10 = Test_Netcore_TestResources_GetInstanceField_PublicValue_1();
...
is($test_result_10, 1, 'Test_Netcore_TestResources_GetInstanceField_PublicValue_1');
