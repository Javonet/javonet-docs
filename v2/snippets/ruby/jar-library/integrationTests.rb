...
RSpec.describe 'Ruby To Jvm Integration Tests' do
  ...
  it 'Test_Jvm_TestResources_1DArray_GetIndex_2_StringThree' do
  ...
  it 'Test_Jvm_TestResources_1DArray_GetSize_5' do
  ...
  it 'Test_Jvm_TestResources_1DArray_SetIndex_StringSeven' do
  ...
  it 'Test_Jvm_TestResources_1DArray_Iterate' do
  ...
  it 'Test_Jvm_TestResources_1DArray_GetElement' do
  ...
  it 'Test_Jvm_TestResources_1DArray_SetElement' do
  ...
  it 'Test_Jvm_TestResources_1DArray_RetrieveArray' do
  ...
  it 'Test_Jvm_StandardLibrary_GetInstanceField' do
