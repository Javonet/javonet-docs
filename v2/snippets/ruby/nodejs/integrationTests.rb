...
RSpec.describe 'Ruby To V8 Integration Tests' do
  ...
  it 'Test_V8_StandardLibrary_InvokeStaticMethod_Math_Abs_Minus50_50' do
  ...
  it 'Test_V8_StandardLibrary_GetStaticField_Math_PI_PI' do
  ...
  it 'Test_V8_TestResources_LoadLibrary_LibraryPath_NoException' do
    # // <TestResources_LoadLibrary>
    Javonet.in_memory.v8.load_library(library_path)
    # // </TestResources_LoadLibrary>
  end

  it 'Test_V8_TestResources_InvokeStaticMethod_MultiplyByTwo_25_50' do
  ...
  it 'Test_V8_TestResources_GetStaticField_StaticValue_3' do
  ...
  it 'Test_V8_TestResources_SetStaticField_StaticValue_75' do
  ...
  it 'Test_V8_TestResources_InvokeInstanceMethod_MultiplyTwoNumbers_4_5_20' do
    # // <TestResources_InvokeInstanceMethod>
    Javonet.in_memory.v8.load_library(library_path)
    instance = Javonet.in_memory.v8.get_type(class_name).create_instance.execute
  ...
  it 'Test_V8_TestResources_GetInstanceField_PublicValue_1' do
    # // <TestResources_GetInstanceField>
    Javonet.in_memory.v8.load_library(library_path)
    instance = Javonet.in_memory.v8.get_type(class_name).create_instance(7, 8).execute
