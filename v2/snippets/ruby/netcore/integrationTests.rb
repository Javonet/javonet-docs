...
RSpec.describe 'Ruby To Netcore Integration Tests' do
  ...
  library_path = _javonet_src_root + "/testResources/netcore/NetcoreTestClass.dll";
  ...
  it 'Test_Netcore_StandardLibrary_InvokeStaticMethod_SystemMath_Abs_minus50_50' do
  ...
  it 'Test_Netcore_StandardLibrary_GetStaticField_SystemMath_PI_PI' do
