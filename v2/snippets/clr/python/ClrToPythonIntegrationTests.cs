...
{
    public class ClrToPythonIntegrationTests
	{
        private readonly ITestOutputHelper output;
		//this constructor is called only once, before first test
		public ClrToPythonIntegrationTests(ITestOutputHelper output)
        {
			this.output = output;
			var result = Javonet.Activate("-", "-");
		...
		//[Fact]
		//[Trait("Test", "Integration")]
		//public void Test_Python_StandardLibrary_InvokeInstanceMethod()
		//{
