...
namespace JavonetNS::Cpp::Sdk::Tests::NetframeworkDll {
	...
	TEST(Integration, Test_NetframeworkDll_StandardLibrary_CreateRuntimeContext) {
	...
	TEST(Integration, Test_NetframeworkDll_StandardLibrary_CreateInvocationContext) {
	...
	TEST(Integration, Test_NetframeworkDll_StandardLibrary_GetValue) {
