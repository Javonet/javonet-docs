...
namespace JavonetNS::Cpp::Sdk::Tests::RubyPackage {
	...
	TEST(Integration, Test_RubyPackage_StandardLibrary_CreateRuntimeContext) {
	...
	TEST(Integration, Test_RubyPackage_StandardLibrary_CreateInvocationContext) {
		...
		auto invocationContext = calledRuntime->GetType("Math")->InvokeStaticMethod("sqrt", 2500);
	...
	TEST(Integration, Test_RubyPackage_StandardLibrary_GetValue) {
