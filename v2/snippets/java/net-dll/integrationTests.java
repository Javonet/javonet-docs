...
public class integrationTests {
    ...
    private final String resourcesDirectory = java.nio.file.Paths.get("").toAbsolutePath().getParent().getParent().toString()
            + "/testResources/net-dll";

    @BeforeAll
    public static void initialization() {
        int result = Javonet.activate(utils.ActivationCredentials.yourLicenseKey);
        Assertions.assertEquals(0, result);
    }

    @Test
    @Tag("integration")
    public void Test_NetDll_StandardLibrary_CreateRuntimeContext() {
    ...
    @Test
    @Tag("integration")
    public void Test_NetDll_StandardLibrary_CreateInvocationContext() {
    ...
    @Test
    @Tag("integration")
    public void Test_NetDll_StandardLibrary_GetValue() {
    ...
    @Test
    @Tag("integration")
    public void Test_NetDll_TestResources_Cast_ToUInt32() {
    ...
    @Test
    @Tag("integration")
    public void Test_NetDll_TestResources_EnumAddToList() {
    ...
    @Test
    @Tag("integration")
    public void Test_NetDll_TestResources_EnumNameAndValue() {
    ...
    @Test
    @Tag("integration")
    public void Test_NetDll_StandardLibrary_HandleSet() {
    ...
    @Test
    @Tag("integration")
    public void Test_NetDll_TestResources_PassingNullAsOnlyArg() {
    ...
    @Test
    @Tag("integration")
    public void Test_NetDll_TestResources_PassingNullAsSecondArg() {
    ...
    @Test
    @Tag("integration")
    public void Test_NetDll_TestResources_ReturningNull() {
    ...
    @Test
    @Tag("integration")
    public void Test_NetDll_TestResources_InvokeMethodWithNullables() {
    ...
    @Test
    @Tag("integration")
    public void Test_NetDll_TestResources_MethodWithNullArgument() {
...
//    @Test
//    @Tag("integration")
//    public void Test_NetDll_TestResources_Multithreading_InvokeInstanceMethod() throws Exception {
...
//    }
    ...
    @Test
    @Tag("integration")
    public void Test_NetDll_TestResources_ExecuteAsync_AsyncMethod() {
    ...
    @Test
    @Tag("integration")
    public void Test_NetDll_TestResources_ExecuteAsync_SyncMethod() {
...
//    @Test
//    @Tag("integration")
//    public void Test_NetDll_TestResources_ExecuteAsync_SyncMethod_Await() throws Exception {
...
//    }
    ...
    @Test
    @Tag("integration")
    public void Test_NetDll_TestResources_UseStaticMethodAsDelegate() throws Exception {
    ...
    @Test
    @Tag("integration")
    public void Test_NetDll_TestResources_UseInstanceMethodAsDelegate() throws Exception {
