...
func Test_PythonPackage_TestResources_ExceptionsFromCalledTech_InvokeStaticMethod_DivideBy_0_ThrowsException(t *testing.T) {
	...
	// create called runtime context
	calledRuntime, err := Javonet.InMemory().Python()
	if err != nil {
