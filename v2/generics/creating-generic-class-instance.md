:::options
:title: Creating generic `{calling_name}` class instance from `{called_name}`
:description: This article provides an overview of creating `{calling_name}` generic class instance from `{called_name}`
...
# Create generic `{calling_name}` class instance from `{called_name}`
...
## Generic `{calling_name}` class from framework
