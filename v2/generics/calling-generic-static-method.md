:::options
:title: Calling generic `{calling_name}` static method from `{called_name}`
:description: This article provides an overview of calling generic `{calling_name}` static method from `{called_name}`
...
# Call generic `{calling_name}` static method from `{called_name}`
