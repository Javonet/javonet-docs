:::options
:title: Call `{called_name}` generic static method in `{called_name}` application
:description: This article provides an overview of calling  `{called_name}` generic static method in `{called_name}` application.
...
# Call `{called_name}` generic static method in `{called_name}` app
...
## Custom `{called_name}` with generic static methods
